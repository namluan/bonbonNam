    ...
    <nav class="navbar bg-body-tertiary">
        ...
        <div class="mx">
                <form class="container-fluid d-flex">
                    <button class="btn btn-outline-danger me-2" type="button" name="panier">Panier</button>
                </form>
    ...
    while($produit = $resultat->fetch(PDO::FETCH_OBJ))
        {
            ...
            <div class="card-body">
                ...
                <form action="ajout_panier.php" method="$_GET">
                    <a href="ajout_panier.php?id='.$produit->id.'" class="btn btn-danger">Ajouter au Panier</a>
                </form>
            </div>
        </div>';
        }
